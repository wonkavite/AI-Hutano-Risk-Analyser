          ...
          <div>
            ...
            <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Link
                  to="/#navbar"
                  className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-blue-100 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-1"
                >
                  Home
                </Link>
